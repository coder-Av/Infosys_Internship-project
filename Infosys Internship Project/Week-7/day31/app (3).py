...
# Sidebar
with st.sidebar:
    default_data_path = os.path.join(PROJECT_DIR, "Data_base_files", "preprocessed_earthquake_data.csv")
    default_model_path = os.path.join(PROJECT_DIR, "models", "lgb_damage_model.pkl")
    data_path  = st.text_input("CSV path", default_data_path)
    model_path = st.text_input("Model file", default_model_path)
